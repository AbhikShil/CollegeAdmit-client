...
import OrdersCollegeApproved from "../../components/order/OrdersCollegeApproved";
    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-md-8 mt-2">
          ...
          <OrdersCollegeApproved user={user} ordersData={ordersData} handleStatusChange={handleStatusChange} />
        </div>
      </div>
    </div>
  );

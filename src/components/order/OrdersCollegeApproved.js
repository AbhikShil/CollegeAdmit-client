...
const OrdersCollegeApproved = ({ user , ordersData, handleStatusChange }) => {
  ...
  return (
    <>
      {ordersData.map((order) =>{return (order.colleges[0].college._id==userInfo.college_id && order.orderStatus=="Profile Eligible .Seat Is Successfully Booked.")?(
...
export default OrdersCollegeApproved;

...
const OrdersCollegeRejected = ({ user, ordersData }) => {
  ...
  return (
    <>
      {ordersData.map((order) =>{return (order.colleges[0].college._id==userInfo.college_id && order.orderStatus=="Profile Rejected. Apply Again!")?(
...
export default OrdersCollegeRejected;

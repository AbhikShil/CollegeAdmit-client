...
const OrdersAdminApproved = ({ user , ordersData, handleStatusChange }) => {
  ...
  return (
    <>
      {ordersData.map((order) =>{return ( order.orderStatus=="Profile Eligible .Seat Is Successfully Booked.")?(
...
export default OrdersAdminApproved;
